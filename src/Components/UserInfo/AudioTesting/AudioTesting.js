...
const AudioTesting = () => {
    ...
    return (
        <div className={styles['audio-testing']}>
            <img className={styles['step-two']}
                src='/images/Group 10.svg'
                alt='Bước 2'
                width={400}
                height={40.25}
            />
            <p className={styles['p1']}>- Bước 1: Đeo tai nghe và nghe một đoạn âm thanh phía dưới.</p>
            ...
            <div className={styles['mic-check']}>
                ...
                <div className={styles['mic-check-end']}>
                    <button onClick={handleStopRecording} disabled={!recordingAudio}>Nghe lại</button>
                </div>
            </div>
            ...
            <p>- Bước 4: Nếu không nghe được giọng nói của mình vui lòng thông báo cho giám thị.</p>
        </div>
    );
};
